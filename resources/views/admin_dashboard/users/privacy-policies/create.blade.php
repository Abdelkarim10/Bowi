...
{{-- <div class="card" style="width: 90%">  
    <div class="card-header">Creating Privacy Policy</div>
    <div class="card-body">



        <form action="{{ url('privacy-policies') }}" method="post" enctype="multipart/form-data" >
            {!! csrf_field() !!}
