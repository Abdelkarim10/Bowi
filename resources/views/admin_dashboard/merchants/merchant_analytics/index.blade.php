...
@section('content')
{{-- <div style="width: 98%;margin:auto"> <a href="/merchant-analytics/table" class="btn " style="float: right;font-size:25px;font-weight:400 "> Table  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" class="bi bi-arrow-right " viewBox="0 0 16 16" style="size: 20px">
    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
         ...
         <div style="width: 98%;margin:auto;display: flex;">
              <div style="width: 48%;">
                 ...
                 <canvas  id="buyonegetone" width="70" height="30"></canvas>
...
{{-- <div style="display: flex;width: 98%;margin:auto">
  <div style="width: 75%;margin:auto">
    <h1>Total</h1>
    <canvas  id="total" width="100" height="30"></canvas>
    <br><br>
  </div> --}}
  ...
  <div class="AdminAna">
    ...
    <div class="analyticsTopBtns"> 
        <div class="analyticsBtnsHub">
          <a href="/merchant-analytics" style="color: white ; background-color: black;">Buy One Get one</a>
          <a href="/merchant-analytics1">Discount</a>
  ...
  <script  type="text/javascript">  
    ...
    $buy1get1 = json_decode($buy1get1, true);

    for($i = 0;$i < count($buy1get1);$i++){
      echo "buy1get1[" . ($buy1get1[$i]['month'] - 1) . "] = " . $buy1get1[$i]['num'] . ";";
    }
