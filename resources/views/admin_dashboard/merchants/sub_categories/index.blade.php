        ...
        <div class="col-md-9" style="width:60% ;">
            <div class="card">
                <div class="card-header">
                    <h2>
                      All Sub Categroies </h2>
                </div>
                <div class="card-body">
                    <a href="{{ route('sub-categories.create') }}"   class="btn btn-success btn-sm" title="Add New news">
                        Add Sub Category
                    </a>
                    <br>
                    <br />
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $subCat->name }}</td>
                                    <td class="align-middle">
