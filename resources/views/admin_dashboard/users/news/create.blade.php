...
{{-- <div class="card" style="width: 90%">
    <div class="card-header">Creating News</div>
    <div class="card-body">
...
<div class="CreatePost">
    ...
    <form action="{{ url('news') }}" method="post" enctype="multipart/form-data" >
        ...
        <h5>Content</h5>
        <textarea class="CreatePostInput" type="text" name="content" id="content" style="height: 200px;resize:none"></textarea>

        <h5>Picture</h5>
        <input class="CreatePostImage" type="file" accept=".jpeg,.png,.jpg,.gif,.svg" name="pic" id="pic">
