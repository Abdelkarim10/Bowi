    ...
    <div class="AdminAna">
      ...
      <div class="analyticsTopBtns"> 
          <div class="analyticsBtnsHub">
              <a href="/analytics" style="color: white ; background-color: black;">Payments Received</a>
      ...
      <div>
          ...
          <div class="graph">
              <div style="width: 70%">
                  <canvas  id="paymentReceived" width="70" height="30"></canvas>
              </div>
          </div>
      </div>
      <div class="container">
...
<script  type="text/javascript">  
  ...
  for($i = 0;$i < count($payment);$i++){
    echo "payment[" . ($payment[$i]['month'] - 1) . "] = " . $payment[$i]['num'] . ";";
  }
